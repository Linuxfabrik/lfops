...
* **role:trend_micro**: Add a role to install and activate the Trend Vision One Endpoint Security agent (Endpoint Sensor and Server & Workload Protection) on RHEL 9 and RHEL 10.

...
* **role:apache_tomcat**: Add support for Tomcat 10.1, whose `tomcat-users.xml` stores the passwords from `apache_tomcat__users__*_var` as an unsalted sha-256 digest instead of in clear text.

...
#
# Temporary copy with --diff support. Remove once
# https://github.com/freeipa/ansible-freeipa/pull/1415
...
from ansible_collections.linuxfabrik.lfops.plugins.module_utils.ipa_diff import \

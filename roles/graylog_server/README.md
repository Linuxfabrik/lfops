...
| -------- | ----------- |
| `graylog_server__admin_user` | The main user account for the graylog administrator. Subkeys:<ul><li>`username`: Username</li><li>`password`: Password</li><li>`email`: Optional, string. Email. Defaults to `''`.</li></ul> |

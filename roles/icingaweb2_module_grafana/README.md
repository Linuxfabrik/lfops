...
Additionally, it deploys the grafana graphs as well as the graph configuration for the [Linuxfabrik Monitoring Plugins](https://github.com/Linuxfabrik/monitoring-plugins). This can be disabled using `icingaweb2_module_grafana__skip_monitoring_plugins_dashboards` and `icingaweb2_module_grafana__skip_monitoring_plugins_graphs_config`.
...
| `icingaweb2_module_grafana:monitoring_plugins_dashboards` | Deploys the Grafana graphs for the [Linuxfabrik Monitoring Plugins](https://github.com/Linuxfabrik/monitoring-plugins)               |
...
icingaweb2_module_grafana__skip_monitoring_plugins_dashboards: true

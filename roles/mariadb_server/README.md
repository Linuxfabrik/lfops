...
| `mariadb_server__cnf_binlog_cache_size__group_var` / `mariadb_server__cnf_binlog_cache_size__host_var` | [mariadb.com](https://mariadb.com/kb/en/replication-and-binary-log-system-variables/#binlog_cache_size) | `'32K'` |
...
| `mariadb_server__cnf_eq_range_index_dive_limit__group_var` / `mariadb_server__cnf_eq_range_index_dive_limit__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#eq_range_index_dive_limit) | `200` |
...
| `mariadb_server__cnf_innodb_adaptive_hash_index__group_var` / `mariadb_server__cnf_innodb_adaptive_hash_index__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_adaptive_hash_index) | `'OFF'` |
| `mariadb_server__cnf_innodb_adaptive_hash_index_parts__group_var` / `mariadb_server__cnf_innodb_adaptive_hash_index_parts__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_adaptive_hash_index_parts) | `8` |
...
| `mariadb_server__cnf_innodb_max_dirty_pages_pct__group_var` / `mariadb_server__cnf_innodb_max_dirty_pages_pct__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_max_dirty_pages_pct) | `90` |
| `mariadb_server__cnf_innodb_max_purge_lag__group_var` / `mariadb_server__cnf_innodb_max_purge_lag__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_max_purge_lag) | `0` |
| `mariadb_server__cnf_innodb_monitor_disable__group_var` / `mariadb_server__cnf_innodb_monitor_disable__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_monitor_disable) | `''` |
| `mariadb_server__cnf_innodb_open_files__group_var` / `mariadb_server__cnf_innodb_open_files__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_open_files) | `0` (auto) |
| `mariadb_server__cnf_innodb_print_all_deadlocks__group_var` / `mariadb_server__cnf_innodb_print_all_deadlocks__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_print_all_deadlocks) | `'OFF'` |
| `mariadb_server__cnf_innodb_purge_batch_size__group_var` / `mariadb_server__cnf_innodb_purge_batch_size__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_purge_batch_size) | `127` |
| `mariadb_server__cnf_innodb_read_io_threads__group_var` / `mariadb_server__cnf_innodb_read_io_threads__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_read_io_threads) | `4` |
| `mariadb_server__cnf_innodb_strict_mode__group_var` / `mariadb_server__cnf_innodb_strict_mode__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_strict_mode) | `'ON'` |
| `mariadb_server__cnf_innodb_sync_spin_loops__group_var` / `mariadb_server__cnf_innodb_sync_spin_loops__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_sync_spin_loops) | `30` |
| `mariadb_server__cnf_innodb_write_io_threads__group_var` / `mariadb_server__cnf_innodb_write_io_threads__host_var` | [mariadb.com](https://mariadb.com/kb/en/innodb-system-variables/#innodb_write_io_threads) | `4` |
...
| `mariadb_server__cnf_local_infile__group_var` / `mariadb_server__cnf_local_infile__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#local_infile) | `'ON'` |
| `mariadb_server__cnf_lock_wait_timeout__group_var` / `mariadb_server__cnf_lock_wait_timeout__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#lock_wait_timeout) | `86400` |
...
| `mariadb_server__cnf_log_bin_trust_function_creators__group_var` / `mariadb_server__cnf_log_bin_trust_function_creators__host_var` | [mariadb.com](https://mariadb.com/kb/en/replication-and-binary-log-system-variables/#log_bin_trust_function_creators) | `'OFF'` |
...
| `mariadb_server__cnf_long_query_time__group_var` / `mariadb_server__cnf_long_query_time__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#long_query_time) | `10` |
...
| `mariadb_server__cnf_net_read_timeout__group_var` / `mariadb_server__cnf_net_read_timeout__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#net_read_timeout) | `30` |
| `mariadb_server__cnf_net_write_timeout__group_var` / `mariadb_server__cnf_net_write_timeout__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#net_write_timeout) | `60` |
...
| `mariadb_server__cnf_plugin_maturity__group_var` / `mariadb_server__cnf_plugin_maturity__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#plugin_maturity) | `''` |
...
| `mariadb_server__cnf_server_id__group_var` / `mariadb_server__cnf_server_id__host_var` | [mariadb.com](https://mariadb.com/kb/en/replication-and-binary-log-system-variables/#server_id) | `1` |
...
| `mariadb_server__cnf_table_open_cache__group_var` / `mariadb_server__cnf_table_open_cache__host_var` | [mariadb.com](https://mariadb.com/kb/en/server-system-variables/#table_open_cache) | `2000` |

...
| `icinga2_master:logrotate` | Deploys the Icinga2 logrotate config. Serves as a hotfix for the following issue: [RLIMIT permission warnings](https://github.com/Icinga/icinga2/issues/10617) | - |

...
* Installs and configures audit.
* Triggers: none.

`audit:state`

* Starts, stops or restarts the audit daemon.
* Triggers: none.


## Optional Role Variables

`audit__action_mail_account`
...
`audit__admin_space_left_action`

...
| `postfix__smtp_sasl_security_options` | Postfix SMTP client SASL security options. Possible options:<br>* `noplaintext`<br>* `noactive`<br>* `nodictionary`<br>* `noanonymous`<br>* `mutual_auth` | `'noanonymous'` |

...
| -------- | ----------- |
| `borg_local__passphrase_mail` | The mail address to send the borg passphrase to. |
...
| `borg_local__on_calendar_daily_enabled` | Whether the daily backup should be enabled. | `true` |
...
| `borg_local__on_calendar_hourly_enabled` | Whether the hourly backup should be enabled. | `false` |
